            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="book-history.php" class="nav-item nav-link active">Appointment History</a>
        ...
        <div class="modal-body">
                <div class = "form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="date" class="form-control form-control-user" name = "date"  autofocus min="<?php echo date('Y-m-d')?>" required>
        ...
        if(isset($_POST['Send'])){
            ...
            if(strtotime($time1) > strtotime($time2)){
                                        echo '<script>
        									...
        									swal({
        									title: "Failed!",
        									text: "Please Choose Another Time Schedule",
        									icon: "error",
        									button: "Ok",
        									});}
        								</script>';
            ...
            if($count==0){
    				...
    				if (mysqli_query($conn, $sql_sched1)){
                                        ...
                                        echo '<script>
        									...
        									swal({
        									title: "Failed!",
        									text: "Please Choose Another Schedule",
        									icon: "error",
        									button: "Ok",
        									});}
        								</script>';
    ...
    <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3"> Appointment History</h1>
            </div>
            <div class="row g-4">
               <?php
                	...
                	while($f_e1=$q_e1->fetch_array()){
                                ...
                                $q2 = $conn->query("SELECT COUNT(*) AS count_id FROM `dental_history` WHERE `appointment_desc` = '$appointment_id'");
                                $f2 = $q2->fetch_array();
                ?>
                        ...
                        <h5 class="mb-3" style="text-transform:capitalize;"><?php echo $f1['services_name']?> - <?php echo $f_e1['appointment_status']?> </h5>
                           ...
                           <?php 
                            if( $f2['count_id']>=1){
                                ...
                                $q3 = $conn->query("SELECT * FROM `dental_history` WHERE `appointment_desc` = '$appointment_id'");
                                $f3 = $q3->fetch_array();
                           ?> 
