  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="section-approve.php"  class = "btn-danger btn-m btn" >Approved</a>
	   ...
	   ?>
					<tr>
						...
						<td id="printPageButton">    
						    <a href="view-history.php?id=<?php echo $u_id_user?>"  class = "btn-danger btn-m btn" >View Data </a>
						    <a href="section-approve.php?update_id=<?php echo $f_e['appointment_desc_id']?>&update=Success"  class = "btn-info btn-m btn" >Success Appointment </a>
						</td>
					</tr>
						<?php
						}	
