    ...
    <div class="content-header">
	  ...
	  <div class="printPageButton">  
			<?php
			        ...
			        $q1 = $conn->query("SELECT * FROM `service` WHERE `service_id` = '$product_id'"));
					$f1 = $q1->fetch_array();
			?>
	   </div>		
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
                      <center>
                      <img src="upload/<?php echo $f1['service_pic']?>" width="50%">
                      </center>
        </div>
        <div class="col-sm-6 mb-3 mb-sm-0">
			...
			<div class="modal-body">
				 <div class  = "modal-body">
                  ...
                  <div class="col-sm-12 mb-3 mb-sm-0">
						<label>Name</label>
                    <input type="text" class="form-control"   style="text-transform:capitalize;"required = "required"name = "name" value="<?php echo $f1['service_name']?>">
                  </div>
                  </div>
				<div class = "form-group row" >
                  <div class="col-sm-12 mb-3 mb-sm-0">
						<label>Price</label>
						<input type="text" name="price" class = "form-control" required  style="text-transform:capitalize;" value="<?php echo $f1['service_price']?>">
						<input type="hidden" name="product_id" class = "form-control" required  style="text-transform:capitalize;" value="<?php echo $_GET['sales_id']?>">
				</div>	
				</div>
				</div>
		</div>
		...
		if(isset($_POST['pyinsert1'])){
		 ...
		 $product_id        = $_POST['product_id']; 
	  	 $update1 = $conn->query("UPDATE `service` SET `service_name` = '$name', `service_price` = '$price' WHERE `service_id` = '$product_id'");	
		 if($update1) { 
									echo '<script>
									function myFunction() {
										swal({
										...
										window.location = "sales-view.php?sales_id='.$product_id.'";
									  });}
