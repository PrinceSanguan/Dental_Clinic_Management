...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Success Order  List</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
		...
		<div class="container-fluid"> 			
            <a href="account.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
							     Order List
			</a>
            <a href="request-list.php" class="btn-info btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
								 Request Purchase
			</a>
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Success Order List
	  ...
	  ini_set('display_errors', 0);
					$q_e = $conn->query("SELECT * FROM `billing` WHERE `billing_status`='Walkin Sales' OR `billing_status`='Delivered' ");
					while($f_e=$q_e->fetch_array()){
						
	   ?>
					<tr>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['billing_ref'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['billing_date']?></td>	
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['billing_status']?></td>		
						<td style="text-size:8px;text-transform:capitalize;">
							<a href="view_sales.php?ref=<?php echo $f_e['billing_ref']?>" class="btn-success btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
