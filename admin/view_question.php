...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  $update = $conn->query("UPDATE `question` SET `status` = '1' WHERE `question_id` = '$id'");	 
								$q1c = $conn->query("SELECT * FROM `question` WHERE `question_id`='$id'"));
								$f_e = $q1c->fetch_array();	
								$qid = $f_e['question_id'];
								$q1c1 = $conn->query("SELECT * FROM `question_answer` WHERE `answer_topic`='$qid'"));
								$f_e1 = $q1c1->fetch_array();	
								$user_id_ans = $f_e1["answer_user"];
								$q1c12 = $conn->query("SELECT * FROM `user_account` WHERE `u_id`='$user_id_ans'"));
								$f_e12 = $q1c12->fetch_array();			
					     ...
					     <div class="modal-body">	
							<div class  = "modal-body">
								<div class = "form-group row" >
									...
									<label>Title</label>
										<p  style="text-transform:capitalize;color:black;"><?php echo $f_e['question_topic'];?></p>
							
									</div>
								<div class="col-sm-6 mb-3 mb-sm-0">
								<div class = "form-group" >
									<label>Question</label>	
										<p style="text-transform:capitalize;color:black;"><?php echo $f_e['question_desc'];?></p>
									</div>	
								</div>	
								</div>	
								<div class = "form-group row" >
								...
								<div class = "form-group" >
									<label>Answer:</label>	
										<p style="text-transform:capitalize;color:black;"><?php echo $f_e1['answer_desc'];?> - <?php echo $f_e12['fname']." ".$f_e12['mname']." ".$f_e12['lname'];?></p>
									</div>	
								</div>	
								</div>	
