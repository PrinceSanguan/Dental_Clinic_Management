            ...
            <div class="card card-prirary cardutline direct-chat direct-chat-primary" >
              ...
              <div class="card-body" >
                <div class="direct-chat-messages fix" id="message-content" style="height:300px;overflow: scroll;display: flex;flex-direction: column-reverse;">
				<?php
				$id_faculty = $_GET['id'];
				...
				while($f_e=$q_e->fetch_array()){
				    ...
				    $result=$conn->query("UPDATE `chat` SET `view`='1'  WHERE `chat_to` = '$id_faculty' AND `chat_user_id` = '$id_faculty' AND `view`=''");
					if($result){}
