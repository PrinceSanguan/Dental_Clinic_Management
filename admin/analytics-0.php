    ...
    <div class="content-header">
       <div class="row mb-2">
	    ...
	    <div class="printPageButton"> 
			 <a href="analytics.php" class="btn btn-info btn-sm">Service Analytics</a>
			 <a href="analytics-0.php" class="btn btn-danger btn-sm">Course Analytics</a>
...
<?php
// Assuming you have already established a database connection and $conn variable is available

// Array of acronyms
$acronyms = array("BSAeE", "BSAT", "BSAMT", "BSAET", "BSAIT", "BSAIS", "BSAvComm", "BSAvLog", "BSAvTour", "BSAvSSM");

// Initialize an empty array to store the counts
$counts = array();

// Loop through each acronym to fetch the count from the database
foreach ($acronyms as $acronym) {
    $sql = "SELECT COUNT(*) AS total FROM `appointment` WHERE `course` = '$acronym' AND `appointment_status` = 'Success'";
...
<script>
    window.onload = function() {
        ...
        var data = {
            labels: <?php echo json_encode($acronyms); ?>,
            datasets: [{
                data: [<?php echo $chart_data; ?>],
                backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#FF5733', '#45B39D', '#F4D03F', '#3498DB', '#D35400', '#58D68D', '#9B59B6']
            }]
        };
