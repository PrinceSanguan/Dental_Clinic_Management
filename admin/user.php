...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">User Management </h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
      ...
      <a href="#" class="btn-info btn-m btn" onClick="window.print();" style="margin-left:10px;">Print</a>
			...
			<div class='card-header py-3  bg-success'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >User Management
  ...
  <table width="100%" class="display" cellspacing="0">
	   ...
	   ?>
					<tr>
						...
						<td ><?php echo $f_e['contact']?></td>
						<td ><?php echo $f_e['bdate']?></td>
						<td ><?php echo $f_e['gender']?></td>
						<td ><?php echo $f_e['address']?></td>
						<td class="no-print">
						    <a href="#" class="btn btn-warning text-white"  data-toggle="modal" data-target="#historyModal<?php echo $f_e['u_id'];?>">View Medical Report</a>
						    <a href="view-history.php?id=<?php echo $f_e['u_id'];?>" class="btn btn-info">View History</a>
