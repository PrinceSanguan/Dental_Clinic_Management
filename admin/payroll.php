...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Employee Payroll</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
		...
		<a href="user.php "  class = "btn-danger btn-m btn"> <i class="fas fa- fa-users"></i> Employee</a>
		<a href="customer-list.php"  class = "btn-info btn-m btn"> <i class="fas fa- fa-users"></i> Client List</a>
		
		<br><br>
		<a href="user.php" class = "btn-info btn-m btn"> <i class="fas fa- fa-user"></i> List</a>	 
		<a href="attendance.php" class = "btn-info btn-m btn"> <i class="fas fa- fa-clock"></i> Attendance</a>	 
		<a href="payroll.php" class = "btn-danger btn-m btn"> <i class="fas fa- fa-money-bill"></i> Payroll</a>	
			<a href="#" class="btn-warning btn-m btn" style="text-transform:capitalize;color:white;text-stroke:2px solid black;float:right;" onclick="window.print()"> 
			...
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Employee Payroll
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            <?php	
					...
					$q_e = $conn->query("SELECT * FROM `attendace` ");
					while($f_e=$q_e->fetch_array()){
	   ?>
					<tr>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['attendace_number'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['attendace_time_in'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php if($f_e['attendace_time_out']==null){ echo "<b style='color:red;'>No Time Out Yet</b>";}else{ echo $f_e['attendace_time_out'];}?></td>	
						<td style="text-size:8px;text-transform:capitalize;">
						<?php 
							$hourdiff = round((strtotime($f_e['attendace_time_out']) - strtotime($f_e['attendace_time_in']))/3600, 1);
							echo $hourdiff;
						?>
						</td>	
					</tr>
...
<div class="modal fade" id="registerEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <?php
	...
	if(isset($_POST['signin'])){
    	...
    	$sql_sched  = "INSERT INTO admin VALUES(null,'$username','$email','$param_password','$position','$fname','$mname','$lname')";	
