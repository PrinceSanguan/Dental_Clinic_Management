...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Lesson Information</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <div class="printPageButton">  
			...
			<i class="fas fa fa-school fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Add New Lesson 
			</a>
	   </div>
			...
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Lesson List
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
                 ...
                 <tbody>		
	   <?php			
					$q_e = $conn->query("SELECT * FROM `youtube`");
	   ...
	   ?>
					<tr>
						...
						<td style="text-size:8px;text-transform:capitalize;"><a target="_blank"href="<?php echo $f_e['youtube_google']?>">Google Link</a></td>		
						<td style="text-size:8px;text-transform:capitalize;"><a target="_blank"href="<?php echo $f_e['youtube_link']  ?>">Youtube Link</a></td>		
						...
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['youtube_sec']?></td>			
						<td style="text-size:8px;text-transform:capitalize;"><a href="add_lesson.php?del_id=<?php echo $f_e['youtube_id'];?>" class="btn-danger btn-sm btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
			<i class="fas fa fa-trash fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Delete Lesson 
			</a></td>		
					</tr>
						<?php
						}	
						if(isset($_GET['del_id'])){
								...
								$result=$conn->query("DELETE FROM youtube WHERE youtube_id='$product_id'");
								if($result){
						date_default_timezone_set('Asia/Manila'); 
        ...
        <div class="modal-header">
         ...
         <form method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype = "multipart/form-data"autocomplete="off" >
			<div class="modal-body">
				...
				<div class = "form-group" >
						<label>Google Transcipt Link </label>
						<input type="text" name="g_module" class = "form-control" required  >
				</div>
				<div class = "form-group" >
						<label>Google Module Link</label>
						<input type="text" name="a_module" class = "form-control" required  >
				</div>
				<div class = "form-group" >
  ...
  if(isset($_POST['pyinsert'])){
	  ...
	  $a_module = $_POST['a_module'];
	  $year = date('Ys');
	  $sql123 ="INSERT INTO youtube VALUES(null,'$title','$grade','$desc','$g_module','$a_module','$y_module','$year','$strand','$sect')";		
