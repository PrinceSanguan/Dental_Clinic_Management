  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="service.php"  class = "btn-danger btn-m btn">Go Back</a>
		...
		<?php 
		        ...
		        $q = $conn->query("SELECT * FROM `services` WHERE `services_id` = '$service_id'");
				$f = $q->fetch_array();
				$services_tools_id = $f['services_tools_id'];
				
				
		        $qs = $conn->query("SELECT * FROM `process_list` WHERE `process_list_id`='$services_tools_id'");
				$fs = $qs->fetch_array();
		?>			
        ...
        <div class="modal-body">
                <div class = "form-group">
					...
					<input type="text" class="form-control form-control-user" name = "s_name" value="<?php echo $f['services_name'];?>" style="text-transform:capitalize;">
				</div>
                <div class = "form-group">
                    <label>Service Cost</label>
					<input type="text" class="form-control form-control-user" name = "s_cost" value="<?php echo $f['services_cost'];?>" style="text-transform:capitalize;">
				</div>
					<input type="hidden" class="form-control form-control-user" name = "s_id" value="<?php echo $service_id;?>">
				
            
        </div>
        <div class="modal-footer">
          <a class="btn btn-secondary" href="service.php">Cancel</a>
...
if(isset($_POST['submit'])){
    ...
    $s_cost = $_POST['s_cost'];
        ...
        $sql1 ="UPDATE `services` SET `services_name` = '$s_name',`services_cost`='$s_cost'WHERE `services_id` = '$s_id'";	
		if (mysqli_query($conn, $sql1)) {    
                echo '<script>
									function myFunction() {
										swal({
										title: "Successfully",
										text: "Update A This Service",
									    icon: "success",
										type: "success"
										}).then(function() {
										window.location = "service-update.php?service_id='.$s_id.'";
									  });}
									</script>';
            }else{
                                echo '<script>
