...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Invoice List</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <div class="printPageButton"> 
		<a href="monitoring.php"  class = "btn-info btn-m btn"> <i class="fas fa- fa-box"></i> Products</a> 
		<a href="walkin.php"  class = "btn-danger btn-m btn"> <i class="fas fa- fa-list"> </i> Invoice List</a> 
	  ...
	  ini_set('display_errors', 0);
					$q_e = $conn->query("SELECT * FROM `billing` ");
	   ...
	   ?>
					<tr>
						...
						<td style="text-size:8px;text-transform:capitalize;">
							<a href="view_subject.php?ref=<?php echo $f_e['billing_ref']?>" class="btn-success btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
