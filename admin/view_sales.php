...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Sales Data</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-danger" type="submit" name="update11">Update</button>
            ...
            <div class="card-body" >
                ...
                <div class="col-sm-4 mb-3 mb-sm-0">
                    <h5 style="text-transform:capitalize;"><b>Address of Customer:</b></h5>
                </div>
                <div class="col-sm-4 mb-3 mb-sm-0">
                    <h5 style="text-transform:capitalize;"><b>Number of Customer:</b></h5>
                </div>
                </div>
			    <div class="form-group row">
                <div class="col-sm-4 mb-3 mb-sm-0">
                ...
                <div class="col-sm-4 mb-3 mb-sm-0">
                     <h6><text style="text-transform:capitalize;"><?php echo $fsc['billing_address'];?></text></h6>
                </div>
                <div class="col-sm-4 mb-3 mb-sm-0">
                    <h6> <?php echo $fsc['billing_number'];?></h6>
                </div>
                </div>
			    <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                     <h5 style="text-transform:capitalize;"><b>Payment Terms:</b> <text style="font-size:15px;"><?php if($fsc['billing_payment_ref']==null){ echo "Cash On Delivery"; }else{ echo "Online Payment <b>Ref No. ".$fsc['billing_payment_ref']."</b>"; }?></text></h5>  
                </div>
                </div>
                </div>
