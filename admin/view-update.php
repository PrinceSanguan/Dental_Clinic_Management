              ...
              <div class="table-responsive" > 
	            <?php	
	                ...
	                ini_set('display_errors', 0);
					        ...
					        $user = $_GET['user_id'];
							$q1 = $conn->query("SELECT * FROM `user_account1` WHERE `u_id`='$user'");
							$f1 = $q1->fetch_array();
	   ?>
					 <form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  method = "POST"  enctype = "multipart/form-data" autocomplete="off" role="form" >
                <div class="row">
                <div class="form-group mt-3 col-sm-4">
                    <label>Last Name</label>
                    <input type="text" class="form-control" id="name" required = "required"placeholder="" name = "lname" value="<?php echo $f1['lname'];?>">
                  </div>
              <div class="form-group mt-3 col-sm-4">
                    <label>First Name</label>
                    <input type="text" class="form-control form-control-user" id="name"	style=" text-transform:capitalize;"required = "required"name = "fname" value="<?php echo $f1['fname'];?>">
                  </div>
              <div class="form-group mt-3 col-sm-4">
                    <label>Middle Name</label>
                    <input type="text" class="form-control form-control-user" id="name"	style=" text-transform:capitalize;"placeholder="" name = "mname" value="<?php echo $f1['mname'];?>">
                  </div>
				</div> <br>
				<div class="form-group row">
                  <div class="col-sm-6">
					<input type="text" class="form-control"  required = "required" name="number" placeholder="Contact Number" 	style=" text-transform:capitalize;" value="<?php echo $f1['number'];?>">
					<div id="status2"></div>
				 </div> 
                  <div class="col-sm-6">
					<input type="email" class="form-control"  required = "required" name="email" id="email2" placeholder="Email Address" value="<?php echo $f1['email'];?>">
					<div id="status2"></div>
				 </div> 
				 </div>
				  <br>
				<div class="form-group row">
                  <div class="col-sm-6">
					...
					<input type="date" class="form-control"  required = "required" name="bdate" value="<?php echo $f1['bdate'];?>">
				 </div> 
                  <div class="col-sm-6">
                      <label>Nationality</label> 
					<input type="text" class="form-control"  required = "required" name="nationality" id="email2" 	style=" text-transform:capitalize;" value="<?php echo $f1['nationality'];?>">
				 </div> 
				 </div>
				  <br>
				<div class="form-group row">
                  <div class="col-sm-6">
					...
					<input type="text" class="form-control"  required = "required" name="place" id="email2" 	style=" text-transform:capitalize;" value="<?php echo $f1['place'];?>">
				 </div> 
                  <div class="col-sm-6">
                      <label>Course</label>
					<input type="text" class="form-control"  required = "required" name="course" 	style=" text-transform:capitalize;" value="<?php echo $f1['course'];?>">
				 </div> 
				 </div>
				  <br>
				<div class="form-group row">
                  <div class="col-sm-3">
					...
					<input type="text" class="form-control"  required = "required" name="occupation" id="email2" 	style=" text-transform:capitalize;" value="<?php echo $f1['occupation'];?>">
				 </div> 
                  <div class="col-sm-9">
                      <label>Complete Address</label>
					<input type="text" class="form-control"  required = "required" name="address" 	style=" text-transform:capitalize;" value="<?php echo $f1['comaddress'];?>">
				 </div>
				 </div>
				  <br>
				<div class="form-group row">
                  <div class="col-sm-6">
					<input type="text" class="form-control"  required = "required" name="guardian_name" placeholder="Guardian Name" value="<?php echo $f1['g_name'];?>">
				 </div> 
                  <div class="col-sm-6">
					<input type="text" class="form-control"  required = "required" name="guardian_number" id="email2" placeholder="Guardian Number" value="<?php echo $f1['g_number'];?>">
				 </div> 
					<input type="hidden" class="form-control"  required = "required" name="user_id" id="email2"value="<?php echo $_GET['user_id'];?>">
				 
				 </div><br>	
                <hr>
              <div style="float:right;">
                <button type="submit" class = "btn btn-primary btn-user btn-block" name="register"  id="register" ><span class = "glyphicon glyphicon-save"></span> Update</button>
              </div> 
              </form>	
              </div>
            </div>
...
if (isset($_POST['register'])) {
    ...
    $sql124 = "UPDATE user_account1 SET 
                fname = '$fname',
                mname = '$mname',
                lname = '$lname',
                email = '$email',
                ...
                comaddress = '$address'
              WHERE u_id = $user_id"; // Make sure to replace $user_id with the actual user ID you want to update
