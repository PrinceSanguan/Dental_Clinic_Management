...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Professor List</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
		...
		<a href="user-prof.php "  class = "btn-danger btn-m btn">Professor List</a>
		<a href="user-staff.php "  class = "btn-info btn-m btn">Staff List</a>
		<a href="#"  class = "btn-warning btn-m btn" style="float:right;"  data-toggle="modal" data-target="#registerEmployee">Add New Account</a>
			...
			<div class='card-header py-3  bg-success'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Professor List
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            <?php	
					...
					$q_e = $conn->query("SELECT * FROM `admin` WHERE `position`='Professor'");
	   ...
	   ?>
					<tr>
						...
						<td >
						    ...
						    <a href="user-prof.php?action=Deactive&user_id=<?php echo $f_e['admin_id']?>" class="btn btn-danger btn-sm" >Deactive</a>
						    <?php }else{ ?>
						    <a href="user-prof.php?action=Active&user_id=<?php echo $f_e['admin_id']?>" class="btn btn-success btn-sm" >Reactive</a> 
						    <?php } ?>
						</td>	
					</tr>
						<?php
...
<div class="modal fade" id="registerEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <?php
	...
	if(isset($_POST['signin'])){
    	...
    	$sql_sched  = "INSERT INTO admin VALUES(null,'$username','$email','$param_password','Professor','$fname','$mname','$lname','','Out','','')";	
    	if (mysqli_query($conn, $sql_sched)){
    $to =     $email;
    $subject = 'Professor Account for - '.$username;
