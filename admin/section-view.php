  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="section-approve.php"  class = "btn-danger btn-m btn" >Go Back</a>
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            <?php	
					...
					$q_e = $conn->query("SELECT * FROM `appointment` WHERE `appointment_user`='$user_id' ");
	   ...
	   ?>
					<tr>
						<td style="display:none;"><?php echo $f_e['appointment_id']?></td>	
						...
						<td ><?php echo $f_e['appointment_service']?></td>	
						<td ><?php echo $f_e['appointment_status']?></td>
						<td >
						    <a href="section-desc.php?update_id=<?php echo $_GET['update_id']?>&appointment_id=<?php echo $f_e['appointment_id']?>&update=Success"  class = "btn-success btn-m btn" >Add Description </a>
						</td>
					</tr>
						<?php
						}	
