  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="printPageButton">  
	    ...
	    <a href="logistic-delivered.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
			 For Delivered
		</a>	 
	    <a href="logistic-return.php" class="btn-success btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
			...
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Logistic Order List for Delivered
	  ...
	  ini_set('display_errors', 0);
					$q_e = $conn->query("SELECT * FROM `request` WHERE `request_status`='Delivered'");
