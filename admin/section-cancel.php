  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="section-cancel.php"  class = "btn-danger btn-m btn" >Re Sched</a>
		...
		<a href="section-excel.php?nav=Re Sched"  class = "btn-warning btn-m btn float-right" >Download</a>
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            <?php	
                    ...
                    $q_e = $conn->query("SELECT * FROM `appointment_desc` WHERE `appointment_status`='Re Schedule' ");
	   ...
	   ?>
					<tr>
						...
						<td id="printPageButton">
						    <a href="section-cancel.php?update_id=<?php echo $f_e['appointment_desc_id']?>&update=Success"  class = "btn-info btn-m btn" >Success Appointment </a>
						</td>
					</tr>
						<?php
						}	
