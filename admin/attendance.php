...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Employee Attendance</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
		...
		<a href="attendance.php" class = "btn-danger btn-m btn"> <i class="fas fa- fa-clock"></i> Attendance</a>	 
		
			 
	  </div>		
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Employee List
