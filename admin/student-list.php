...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Student List</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
		...
		<a href="section.php"  class = "btn-danger btn-m btn"  >Go Back to Section</a>
			 
		</div>
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3  bg-success'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Student List
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            <?php	
					...
					$q_e = $conn->query("SELECT * FROM `admin` WHERE `section`='$section_id' ");
