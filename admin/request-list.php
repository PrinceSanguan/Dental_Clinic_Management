              ...
              <div class="table-responsive" > 
				...
				<tr>
				    ...
				    <td style="text-size:8px;text-transform:capitalize;">
				        <a href="request-view.php?request_id=<?php echo $f_e['request_id'];?>" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;"> 
			            	<i class="fas fa fa-eye fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Update Request
			            </a> 
			        </td>
				</tr>
				<?php
