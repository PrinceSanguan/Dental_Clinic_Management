  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<a href="#"  class = "btn-danger btn-m btn"  data-toggle="modal" data-target="#addModal">Add New Process</a>
	   ...
	   ?>
					<tr>
						<td style="display:none;"><?php echo $f_e['process_list_id']?></td>	
						<td ><?php echo $f_e['process_list_tags']?></td>	
						<td style="text-size:8px;text-transform:capitalize;">
						    <a href="process_desc.php?process_list_id=<?php echo $f_e['process_list_id'];?>"   class = "btn-info btn-m btn">View Process</a>
                            <a href="process_list.php?process_id=<?php echo $f_e['process_list_id']?>&action=del"  class = "btn-danger btn-m btn" onclick = "if (! confirm('Do you Want to Delete this ?')) { return false; }">Delete</a>
						</td>
						...
						if(isset($_GET['action'])){
						    ...
						    $sql_del ="UPDATE `process_list` SET `process_status`='1' WHERE `process_list_id`='$process_id'";	
		                    if (mysqli_query($conn, $sql_del)){    
                                echo '<script>
									function myFunction() {
										...
										window.location = "process_list.php";
									  });}
									</script>';
                            }else{  
                                echo '<script>
...
if(isset($_POST['submit'])){
    $p_name = $_POST['p_name'];
        ...
        $sql1 ="INSERT INTO process_list VALUES(null,'$p_name','0')";	
		if (mysqli_query($conn, $sql1)) {    
                echo '<script>
									function myFunction() {
										swal({
										title: "Successfully",
										text: "Added A New Process",
									    icon: "success",
										type: "success"
										}).then(function() {
										window.location = "process_list.php";
