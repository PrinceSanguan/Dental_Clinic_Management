            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="message.php" class="nav-item nav-link active">Contact 
                        <?php
        					$q1 = $conn->query("SELECT count(*) as count_msg FROM `chat` WHERE `chat_to` = '$id_faculty' AND `chat_user_id`='11' AND `view`=''") or die(msqli_error());
        					$f1 = $q1->fetch_array();
